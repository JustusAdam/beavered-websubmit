...
; This will put the model's predicates, etc. in scope.
(require "analysis_result.frg") 
(require "basic_helpers.frg")
(require "framework_helpers.frg")
(require "props.frg")
...
(run my-run
    #:preds [find_incomplete_one_deleter]
    #:scope ([IncompleteFlow 1])
    #:bounds Flows)
